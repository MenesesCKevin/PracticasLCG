...
CTexture text7; //madera
CTexture text8;//pino
CTexture text9; //tronco
CTexture text10; //esfera
CTexture text11; //esfera
CTexture text12; //esfera
CTexture text13; //esfera
CTexture text14; //esfera
...
void InitGL ( GLvoid )     // Inicializamos parametros
{
	...
	text7.LoadTGA("madera.tga");
	text7.BuildGLTexture();
	text7.ReleaseImage();
	text8.LoadTGA("pino.tga");
	text8.BuildGLTexture();
	text8.ReleaseImage();
	text9.LoadTGA("tronco.tga");
	text9.BuildGLTexture();
	text9.ReleaseImage();
	text10.LoadTGA("esfera.tga");
	text10.BuildGLTexture();
	text10.ReleaseImage();
	text11.LoadTGA("esfera1.tga");
	text11.BuildGLTexture();
	text11.ReleaseImage();
	text12.LoadTGA("esfera2.tga");
	text12.BuildGLTexture();
	text12.ReleaseImage();
	text13.LoadTGA("esfera3.tga");
	text13.BuildGLTexture();
	text13.ReleaseImage();
	text14.LoadTGA("esfera4.tga");
...
void display ( void )   // Creamos la funcion donde se dibuja
{
	...
	glPushMatrix();
		...
		glPushMatrix();		
			...
			cilindro.cilindro(1,2,40,11);
			glPopMatrix();
			//Creamos cono
			glPushMatrix();
			glColor3f(0.0, 0.3, 1.0);
			glTranslatef(0.0,2.0,0.0);
			cono.cono(10, 2, 900, 10);
			glPopMatrix();
			//esferas
			glPushMatrix();
			glColor3f(0.0, 0.3, 1.0);
			...
			glPushMatrix();
			glColor3f(0.0, 0.3, 1.0);
			glTranslatef(0.2, 7.0, -1.1);
			glEnable(GL_ALPHA_TEST);
			glAlphaFunc(GL_GREATER, 0.1);
			esfera.esfera(0.3, 30, 50, 13);
			glDisable(GL_ALPHA_TEST);
			glPopMatrix();
			//esferas
			glPushMatrix();
