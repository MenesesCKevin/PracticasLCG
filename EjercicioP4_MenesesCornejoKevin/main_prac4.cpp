...
void display ( void )   // Creamos la funcion donde se dibuja
{
	...
	glLoadIdentity();
		...
		//Poner Código Aquí.
	glTranslatef(0.0 + transX, 0.0 + transY, 0.0 + transZ); //transalada el objeto
	...
	glRotatef(angleZ, 0.0, 0.0, 1.0);
		...
		glPushMatrix();
			...
			glScalef(6.0, 3.0, 4.5);
			prisma();
		glPopMatrix();

		//Boca
		glPushMatrix();
			glTranslatef(9.5, 4.0, 0.0);
